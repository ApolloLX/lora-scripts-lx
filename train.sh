...
train_data_dir="/kaggle/input/mds-0910-1/mds"              # train dataset path | 训练数据集路径
...
output_name="mds"           # output model name | 模型保存名称
...
python -m accelerate.commands.launch ${launchArgs[@]} --num_cpu_threads_per_process=8 "/kaggle/working/lora-scripts/sd-scripts/train_network.py" \
  --enable_bucket \
